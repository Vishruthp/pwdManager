  ...
  return (
    <div className="App">
      <div style={{ display: !isShow ? "block" : "none" }}>
        <span className="login100-form-title">Password Manager</span>
      ...
      >
        <div>
          <span className="login100-form-title">Saved Passwords</span>
          <table>
            <tr>
              <th>Website Name</th>
              <th>Password</th>
                ...
                return (
                  <tr key={key}>
                    ...
                    <td>
                      ...
                      >
                        {val.decryptPassword ? "" : "Click to see"}
                      </button>
                    </td>
                    <td>
                      <button
